...
function verifierDonneesPrestaM($connexion, $ref, $design, $prix)
{
   if ($ref=="" || $design=="" || $prix=="")
   {
      ajouterErreur("Chaque champ suivi du caractère * est obligatoire");
   } 
   if ($nom!="" && estUneDesignPrestation($connexion, $mode, $ref, $design))
   {
      ajouterErreur("La prestation $design existe déjà");
   }
