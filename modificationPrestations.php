...
// Si on ne "vient" pas de ce formulaire, il faut récupérer les données à partir de la base
// Sinon on affiche les valeurs précédemment contenues dans le formulaire
if ($action=='demanderModifPresta')
{
